...
contract DegisLottery is ReentrancyGuard, IDegisLottery, Ownable {
     ...
     * @param _degisTokenAddress: address of the DEGIS token
    ...
    function claimTickets(
        ...
        DegisToken.safeTransfer(msg.sender, rewardToTransfer);
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId].amountCollected -
            amountToShareToWinners);
