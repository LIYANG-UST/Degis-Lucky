...
contract DegisLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    struct Lottery {
        ...
        uint256[4] cakePerBrewardPerTicketInBracketracket;
        ...
        nonReentrant
    {
        ...
        // Calculate number of Degis to this contract
        ...
        for (uint256 i = 0; i < _ticketNumbers.length; i++) {
            ...
            require(
                (thisTicketNumber >= 10000) && (thisTicketNumber <= 19999),
                "Outside range"
            );
     ...
     * @param _brackets: array of brackets for the ticket ids 你想领取的是哪个级别的奖励 e.g. match4 最高级 match1 最低级
    ...
    function claimTickets(
        ...
        cakeToken.safeTransfer(msg.sender, rewardToTransfer);
     ...
     */
    // owner手动注入资金 => 激励计划
    // injector合约注入资金 => insurancePool合约
     ...
     * @dev Only callable by owner
     * @param _minPriceTicketInDegis: minimum price of a ticket in CAKE
     * @param _maxPriceTicketInDegis: maximum price of a ticket in CAKE
     */
