...
// Prepare
	    ...
	    var op = await randomNumber.getOperatorAddress()
	    console.log("randomNumber.operator:",op)
	    await degisBar.genLuckyNumber()

	    // await randomNumber.genRandomNumber(epochId)


		// await sleep(30000) 
		// epochId = await degisBar.getEpochId.call()
	 	//    console.log("epochId",epochId)
		// var random = await randomNumber.getRandomNumber.call(epochId)
